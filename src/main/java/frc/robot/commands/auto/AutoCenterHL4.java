...
import frc.robot.commands.reef.AlignRightReef;
...
public class AutoCenterHL4 extends SequentialCommandGroup {
  public AutoCenterHL4(
    ...
    addCommands(
        ...
        new ParallelCommandGroup(new AlignRightReef(swerve, vision), new L4(arm, elevator, cradle))
            .withTimeout(3),
