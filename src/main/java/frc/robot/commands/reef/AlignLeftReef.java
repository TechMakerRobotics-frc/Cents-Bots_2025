...
public class AlignLeftReef extends Command {
  private SwerveSubsystem swerve;
  private VisionIO io;
  private PIDController xController, yController, rController;
  private Timer timer = new Timer();

  public AlignLeftReef(SwerveSubsystem swerve, Vision vision) {
    this.swerve = swerve;
    io = vision.getVisionIO(VisionConstants.R_CAM_NAME);
  ...
  public void initialize() {
    ...
    xController.setSetpoint(CommandConstantsReef.LEFTX);
    yController.setSetpoint(CommandConstantsReef.LEFTY);
    rController.setSetpoint(CommandConstantsReef.LEFTR);
    timer.restart();
  }
