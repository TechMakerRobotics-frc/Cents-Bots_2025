...
public class L3 extends Command {
  ...
  public L3(Arm arm, Elevator elevator, Cradle cradle) {
    this.arm = arm;
    this.cradle = cradle;
  ...
  public void initialize() {
    if (cradle.frontSensorIsTrue()) {
      arm.runPosition(ArmConstants.ARM_POSITION_L3);
      cradleCommand = false;
    }
  }
  ...
  public void execute() {
    ...
    if (arm.getPosition() > 0.2 && !cradleCommand) {
      cradle.runPosition(CradleConstants.CRADLE_POSITION_L3);
      cradleCommand = true;
    }
