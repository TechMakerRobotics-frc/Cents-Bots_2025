...
public class PathPlannerAutoFlipped extends Command {
  ...
  public void initialize() {
    try {
      PathPlannerPath path = PathPlannerPath.fromPathFile(traj).flipPath();
