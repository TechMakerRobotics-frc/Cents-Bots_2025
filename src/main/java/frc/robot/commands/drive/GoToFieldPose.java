...
public class GoToFieldPose extends Command {
  ...
  public GoToFieldPose(SwerveSubsystem swerve, double fieldX, double fieldY, double headingDegrees) {
    this.swerve = swerve;
  ...
  private void logValues(Pose2d currentPose, ChassisSpeeds targetSpeeds) {
    ...
    Logger.recordOutput("/GoToFieldPose/H/CurrentPoseValue", currentPose.getRotation().getDegrees());
    ...
    Logger.recordOutput("/GoToFieldPose/DistanceToTarget",
