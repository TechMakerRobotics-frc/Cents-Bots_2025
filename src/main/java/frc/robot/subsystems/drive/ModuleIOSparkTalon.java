...
public class ModuleIOSparkTalon implements ModuleIO {
      ...
      case 0:
        driveIO =
            new MotorIOTalonFX(
                ...
                DriveConstants.kDriveClosedLoopOutput);
        turnIO =
            new MotorIOSparkMax(
                SPARK_FL,
  ...
  public void runDriveVelocity(double velocityRadPerSec) {
    driveIO.setVelocity(velocityRadPerSec * DRIVE_GEAR_RATIO);
  }
