...
public class GyroIOPigeon2 implements GyroIO {
  private final Pigeon2 pigeon = new Pigeon2(DriveConstants.PIGEON_ID, DriveConstants.CANBUS);
  ...
  public GyroIOPigeon2() {
    pigeon.clearStickyFault_Hardware();
  ...
  public void updateInputs(GyroIOInputs inputs) {
    ...
    inputs.pitchPositionDegrees = pigeon.getPitch().getValueAsDouble();
    inputs.rollPositionDegrees = pigeon.getRoll().getValueAsDouble();
    ...
    inputs.odometryPitchPositions =
        pitchPositionQueue.stream().mapToDouble((Double value) -> value).toArray();

    inputs.odometryRollPositions =
        rollPositionQueue.stream().mapToDouble((Double value) -> value).toArray();
