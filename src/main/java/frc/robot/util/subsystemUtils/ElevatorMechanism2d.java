...
public class ElevatorMechanism2d {
  ...
  public ElevatorMechanism2d(
    ...
    final LoggedMechanismRoot2d currentPositionRoot =
        mechanism.getRoot("Root", 0.5 * maximumLength, 0);
    this.currentPositionLigament =
        currentPositionRoot.append(
            new LoggedMechanismLigament2d(
                "ZCurrentPositionLigament",
                minimumLength,
                MechanismConstants.ELEVATOR_MECHANISM_STARTING_ANGLE,
