...
public class DoubleJointedArmMechanism2d {
  ...
  private final LoggedMechanismLigament2d currentPositionFirstLigament,
  ...
  public DoubleJointedArmMechanism2d(String key, Color mechanismColor) {
    this(
        key,
        MechanismConstants.MECHANISM_LINE_LENGTH,
        MechanismConstants.MECHANISM_LINE_LENGTH,
        mechanismColor);
  }
   ...
   * @param mechanismColor the color of the mechanism
   */
  public DoubleJointedArmMechanism2d(
      String name, double firstJointLength, double secondJointLength, Color mechanismColor) {
    this.key = "Mechanisms/" + name;
    final double mechanismMiddle =
        MechanismConstants.LIGAMENT_END_TO_EDGE_RATIO * (firstJointLength + secondJointLength);
    ...
    this.currentPositionFirstLigament =
        root.append(
            new LoggedMechanismLigament2d(
                "ZCurrentPositionFirstLigament",
                firstJointLength,
                0,
                MechanismConstants.MECHANISM_LINE_WIDTH,
                new Color8Bit(mechanismColor)));
    this.currentPositionSecondLigament =
        currentPositionFirstLigament.append(
            new LoggedMechanismLigament2d(
                ...
                MechanismConstants.MECHANISM_LINE_WIDTH,
                new Color8Bit(mechanismColor)));
    this.targetPositionFirstLigament =
        root.append(
            new LoggedMechanismLigament2d(
                "TargetPositionFirstLigament",
                firstJointLength,
    ...
    this.targetPositionSecondLigament =
        targetPositionFirstLigament.append(
            new LoggedMechanismLigament2d(
                "TargetPositionSecondLigament",
                secondJointLength,
                0,
   ...
   */
  public void update(
      Rotation2d firstJointCurrentAngle,
      Rotation2d firstJointTargetAngle,
      Rotation2d secondJointCurrentAngle,
      Rotation2d secondJointTargetAngle) {
  ...
  public void updateFirstJoint(
      Rotation2d firstJointCurrentAngle, Rotation2d firstJointTargetAngle) {
  ...
  public void updateSecondJoint(
      Rotation2d secondJointCurrentAngle, Rotation2d secondJointTargetAngle) {
   ...
   * @param secondJointCurrentAngle the current angle of the second joint
   */
  public void setCurrentAngles(
      Rotation2d firstJointCurrentAngle, Rotation2d secondJointCurrentAngle) {
    setFirstJointCurrentAngle(firstJointCurrentAngle);
    setSecondJointCurrentAngle(secondJointCurrentAngle);
  }
