...
public class FieldConstants {
  ...
  public static class ReefPoses {
    ...
    public static final Pose2d A_BLUE =
        new Pose2d(3.279082775115967, 4.191478252410889, new Rotation2d(Units.degreesToRadians(0)));

    /** Position B on the blue alliance side. */
    public static final Pose2d B_BLUE =
        new Pose2d(
            3.279082775115967, 3.8593883514404297, new Rotation2d(Units.degreesToRadians(0)));
