...
/**
 * A class that represents a {@link Translation2d} that can be flipped when the robot is on the red
 * alliance.
 */
public class FlippableTranslation2d extends Flippable<Translation2d> {
   ...
   *     alliance
   */
  public FlippableTranslation2d(
      Translation2d nonFlippedTranslation, boolean shouldFlipWhenRedAlliance) {
