...
/**
 * A class that represents a {@link Rotation2d} that can be flipped when the robot is on the red
 * alliance.
 */
public class FlippableRotation2d extends Flippable<Rotation2d> {
   ...
   * @param shouldFlipWhenRedAlliance should the rotation be flipped when the robot is on the red
   *     alliance
   ...
   * @return the rotation object with the desired angle value
   */
  public static FlippableRotation2d fromRotations(
