...
/**
 * A class that represents a {@link Pose3d} that can be flipped when the robot is on the red
 * alliance.
 */
public class FlippablePose3d extends Flippable<Pose3d> {
   ...
   *     alliance
   */
  public FlippablePose3d(
      double x, double y, double z, Rotation3d rotation, boolean shouldFlipWhenRedAlliance) {
   ...
   */
  public FlippablePose3d(
      Translation3d translation2d, Rotation3d rotation, boolean shouldFlipWhenRedAlliance) {
