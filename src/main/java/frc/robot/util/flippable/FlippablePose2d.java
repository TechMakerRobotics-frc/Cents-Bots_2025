...
/**
 * A class that represents a {@link Pose2d} that can be flipped when the robot is on the red
 * alliance.
 */
public class FlippablePose2d extends Flippable<Pose2d> {
   ...
   * @param shouldFlipWhenRedAlliance should the pose be flipped when the robot is on the red
   *     alliance
   */
  public FlippablePose2d(
      double x, double y, Rotation2d rotation, boolean shouldFlipWhenRedAlliance) {
   ...
   */
  public FlippablePose2d(
      Translation2d translation2d, double rotationRadians, boolean shouldFlipWhenRedAlliance) {
  ...
  /**
   * Gets the rotation value of the pose. The pose will be flipped if the robot is on the red
   * alliance and {@link #shouldFlipWhenRedAlliance} is true.
   *
